...
s.translationDisclaimer = `Este documento é uma tradução. Se ocorrerem discrepâncias ou erros, o <a href="${ f.filename }.en">original em inglês mais recente</a> terá precedência. <a href="#copyright">Os direitos autorais originais</a> pertencem à W3C, como indicado abaixo.`  // text appears only on translated pages
...
s.aboutI18nActivity = "Sobre a Atividade de Internacionalização." // title text for s.about
